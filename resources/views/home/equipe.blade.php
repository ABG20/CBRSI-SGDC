        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           ...
           <a class="collapse-item" href="/these">Thèses</a>
             <a class="collapse-item active" href="/equipe">Equipe de thèse</a>
                ...
                <div class="card-body">
                  <form action="/traitement/jury" method="POST">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="etablissement" class="form-control" placeholder="">
                    </div>
                     <div class="form-group">
                      <label class="form-label">Spécialité *</label>
                       <input type="text" name="specialite" class="form-control" placeholder="">
                    </div>
