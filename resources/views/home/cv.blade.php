        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           ...
           <a class="collapse-item" href="/these">Thèses</a>
            ...
            <a class="collapse-item active" href="/cv"> CV</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Information sur le CV</h1>
            <ol class="breadcrumb">
                  ...
                  <form action="/traitement/prof" method="POST">
                     @csrf
                      ...
                      <select class="form-control" name="type">
                        <option>Rapporteur de thése</option>  
                        <option> Directeur de thése</option>
                        <option> Exaninateur de thése</option>
                        <option> Co-rapporteur de thése</option>
                      </select>
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="mention" class="form-control" placeholder="">
                    </div>
                     <div class="form-group">
