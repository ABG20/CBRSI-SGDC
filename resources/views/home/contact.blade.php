        ...
        <div class="info-wrap">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 info mt-4 mt-lg-0">
              ...
              <h4>Email:</h4>
              <p> <a href="mailto:mesrs.cbrsi@gouv.bj" style="color: black;">mesrs.cbrsi@gouv.bj</a><br>cci.cbrsi@gouv.bj</p>
...
<div class="footer-newsletter">
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright {{ date('Y')}} &middot; <strong><span>CCI-CBRSI</span></strong> | Tous droits reservés.
      </div>
      <div class="credits">
      </div>
    </div>
