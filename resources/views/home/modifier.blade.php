  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">CCI-CBRSI</div>
      </a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="/inf">Personnelles</a>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="/traitement/modifier" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="form-label">Epouse (réservé exclusivement aux candidates mariées)</label>
                      <input type="text" name="epouse" class="form-control" placeholder="" value="{{$candidat->epouse}}">
                    </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="adresse" class="form-control" required value="{{$candidat->adresse}}">
                    </div>
                    <div class="form-group">
                      <label class="form-label">Date de naissance *</label>
                       <input type="date" name="date_nais" class="form-control" required value="{{$candidat->date_nais}}">
                    </div>
                    <div class="form-group">
                      <label class="form-label"> Ville de naissance *</label>
                      <input type="text" name="ville_nais" class="form-control" required value="{{$candidat->ville_nais}}">
                    </div>
                    <div class="form-group">
...
<option value="Zimbabwe">Zimbabwe </option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="photo" class="form-control" id="photoInput"  required value="{{$candidat->photo}}">
