      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" style="color:black;">Finaliser votre Inscription en cliquant sur Terminé</h1>
            <ol class="breadcrumb">
...
<br>
 ...
 <center><h1 style="margin-left:400px; margin-top:20px; margin-bottom:20px;" class="text-primary">Thèses</h1></center>
...
<center><h1 style="margin-left:400px; margin-top:20px; margin-bottom:20px;" class="text-primary" >Diplômes</h1></center>
  ...
  <tr style="color:black;">
   ...
   @endforeach
               ...
               <form method="POST" action="/notification">
                @csrf
                 <button class="btn btn-success" type="submit" onclick="return confirm('vous avez vraiment fini? ')">Terminer</button>
              </form>
                             </div>
        <!---Container Fluid-->
