  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <div class="logo me-auto">
        <a href="#"><img src="dash/img/logo/logo_cbrsi.jpg" ></a>
    ...
    <div class="hero-container">
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-image: url(home/assets/img/slide/ban_guide1.png);">
...
DES ENSEIGNANTS <br>CHERCHEURS & CHERCHEURS</h2>
                ...
                <div>
                  <a href="#book-a-table" class="btn-book animate__animated animate__fadeInUp scrollto">En-savoir-plus</a>
                </div>
              </div>
            </div>
          </div>
...
<div class="footer-newsletter">
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright {{ date('Y')}} &middot; <strong><span>CBRSI</span></strong>|Tous droits reservés.
      </div>
      <div class="credits">
      </div>
    </div>
