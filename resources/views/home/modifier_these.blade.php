          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="/modifier/traitement_these" method="POST" enctype="/multipart/form-data">
                     @csrf
                      <div class="form-group">
                      <label class="form-label">Type *</label>
                      <select class="form-control" name="type" required>
                        <option value="{{$these->type}}">{{$these->type}}</option>
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="titre" class="form-control" placeholder="" required value="{{$these->titre}}">
                    </div>
                     <div class="form-group">
                      <label class="form-label">Institution de soutenance *</label>
                      <input type="text" name="institution" class="form-control" placeholder="Intitulé/Ville/Pays" required value="{{$these->institution}}" >
                    </div>
                     <div class="form-group">
                      <label class="form-label">Mention *</label>
                      <input type="text" name="mention" class="form-control" placeholder="" required value="{{$these->mention}}" >
                    </div>
                     <div class="form-group">
                      <label class="form-label">Date de soutenance *</label>
                      <input type="date" name="date" class="form-control" placeholder="" required value="{{$these->date}}" >
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="file" name="fichier" class="form-control" placeholder="" required value="{{'/storage/these/'.$these->fichier}}">
                    </div>
