                    ...
                    <ul>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ isset($diplome) ? '/modifier_diplome/'.$diplome->id : '/traitement/diplome' }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @if (isset($diplome))
                                                @method('PUT')
                                            @endif
                       ...
                       <option value="Zimbabwe">Zimbabwe </option>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <input type="file" name="fichier" class="form-control" placeholder="" value="{{isset($diplome)? $diplome->fichier : "" }}" {{isset($diplome)? '' : "required" }}>
                                           </div>
