      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          <div class="container-fluid" id="container-wrapper">
            ...
            <div class="row">
                <div class="col-12"
                    style="background: #3CAD46; border-radius: 20px; padding: 15px; color: black;">
                    <h5> Bienvenue <strong>{{ Auth::user()->nom }} {{ Auth::user()->prenom }} </strong>vous
                        pouvez télécharger le Quide d'utilisation <a href="">«« ici»»</a> </h5>
                </div>
            </div>
        </div>
