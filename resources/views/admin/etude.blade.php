        ...
        <!-- Container Fluid-->
         <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
           <h1 class="h3 mb-0 text-gray-800" style="text-align:center; margin-left:350px; font-weight: bold;">Valider ou Refuser dossier</h1>
...
<tr>
  ...
  <td>
    <div>
     <form method="POST" action="/valider/{{$candidat->user_id}}" style="display:inline-block;">
                @csrf
                 <button class="btn btn-success" type="submit" style="background: #3CAD46;"  onclick="return confirm(' Voulez vous Valider le dossier de ce candidat? ')">Valider</button>
              </form>
               <form method="POST" action="/refuser/{{$candidat->user_id}}" style="display:inline-block">
                @csrf
                 <button class="btn btn-danger" type="submit" style="background: #FF0000;" onclick="return confirm(' Voulez vous Refuser le dossier de ce candidat? ')">Refuser</button>
              </form>
              </div>
