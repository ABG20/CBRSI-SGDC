      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
              <h1 style="text-align:center; margin-left:400px; font-weight:bold; font-size: 30px;"> Etudier les dossiers</h1>
              <br>
              <br>
...
<tr style="color: white;" >
  ...
  <td>
<a href="/dossier/{{$candidat->id}}" class="badge badge-outline-success" style="background: #3CAD46; color:white;" onclick="return">Etudier dossier</a>
